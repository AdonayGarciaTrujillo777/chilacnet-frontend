...
import logo from '../assets/logoC.png'; // Asegúrate de que esta ruta sea correcta
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const respuesta = await fetch('https://chilacnet-backend.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
